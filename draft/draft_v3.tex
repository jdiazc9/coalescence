...
the effect of the cohorts in the dominants pairwise competition
(\figref[a]{fig2})
and the strength of top-down co-selection
(\figref[b]{fig2}, left and middle panels).
Our model suggests that this might be a result of the metabolic interactions
...
We went back to our original simulations and plotted the frequency of the invasive dominant
...
We went back to our synthetic communities
...
\centering
\internallinenumbers
\includegraphics[width=13cm,keepaspectratio]{figs/fig4_v2.pdf}
...
\centering
\internallinenumbers
\includegraphics[width=13cm,keepaspectratio]{figs/fig5.pdf}
