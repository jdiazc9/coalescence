...
\mr Rearrange this section to follow the flow of the new figure 2.
Also introduce the model here and cook a nice experiment-theory-experiment sandwich later.
...
\mr Reframe the entire simulations section (include it in previous two sections?).
Sandwich: the model predicts a) that positive bottom-up co-selection is much more common than
negative bottom-up co-selection... and we see it in the experiments; and b) that in the instances
where bottom-up co-selection is strong (green area in figure 3...), the relative frequency of the dominants
in head-to-head pairwise competition is a very poor predictor of community coalescence outcomes...
which we confirm experimentally.
Conclusions: results and previous theoretical and experimental work on different systems (and on the
