...
\subsubsection*{Top-dow co-selection is weak}
...
We found that the pairwise competitive ability of an invasive dominant
...
(\figref[a]{fig2}, $R^2=0.15$, $p<$ for glutamine and $R^2=0.15$, $p<$ for citrate).
Alternative quantifications of community distance also yield weak effects,
and even more so when the metric used
