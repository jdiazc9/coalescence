...
\textcolor{red}{To do: figSX, re-write minimal model, check literature, check p-values.}
...
the glutamine and citrate communities behave very similarly and both have similar degrees of top-down cohesiveness
(\figref[e]{fig3} right panel,
$R^2=0.27$ for the glutamine environments, in red; $R^2=0.54$ for the citrate environments, in blue;
and $R^2=0.37$ when both environments are considered, black line).
...
($\mathrm{S}_1$ and $\mathrm{s}_1$ in the resident and invasive communities
respectively)
